...
published: true
description: Tired of Git GUIs eating gigabytes of memory and accidentally deleting your uncommitted work? Meet FlowGit v0.1.3 — powered by Tauri v2, Rust native libgit2, and Svelte 5.
tags: rust, git, svelte, webdev
...
- 🔗 **GitHub Repository:** [https://github.com/longgoll/flow-git](https://github.com/longgoll/flow-git)
- 🌐 **Official Website & Docs:** [https://longgoll.github.io/flow-git/](https://longgoll.github.io/flow-git/)
- 🪟 **Download for Windows:** Available on GitHub Releases (`.exe` / `.msi`) or the Microsoft Store.
- 🍏 🐧 **macOS & Linux:** Build from source or grab the cross-platform release builds.
