...
<header class="relative z-40 h-12 border-b border-zinc-200 dark:border-zinc-800/80 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md px-2 sm:px-3 flex items-center justify-between select-none shrink-0 gap-1.5 sm:gap-2 w-full max-w-full overflow-x-clip">
  ...
  <div class="flex items-center gap-1 sm:gap-1.5 shrink-0 min-w-0 justify-end">
    ...
    <!-- Theme Switcher Button (Compact Icon) -->
    <button
      onclick={() => themeState.toggleTheme()}
      class="p-1.5 rounded-md border border-transparent hover:border-zinc-200 dark:hover:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-all cursor-pointer shrink-0"
    ...
    <!-- Account / Login Button (Compact Avatar) -->
    {#if onOpenAuth}
      <button
        onclick={onOpenAuth}
        class="p-1 rounded-md border transition-all cursor-pointer group shrink-0 {activeAccount ? 'bg-zinc-100 dark:bg-zinc-800 border-zinc-200 dark:border-zinc-700 text-zinc-800 dark:text-zinc-200 hover:bg-zinc-200/80 dark:hover:bg-zinc-750' : 'hover:bg-zinc-100 dark:hover:bg-zinc-800 border-transparent text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white'}"
