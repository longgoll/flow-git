...
<form onsubmit={handleValidateAndSaveToken} class="p-6 space-y-4 select-none">
  <!-- Scopes explanation card -->
  <div class="p-3.5 bg-indigo-50 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-500/30 rounded-xl text-xs text-indigo-900 dark:text-indigo-200 space-y-2">
  ...
  <div class="space-y-1.5">
    ...
    <div class="relative">
      <input
        ...
        class="w-full px-3 py-2 text-xs bg-white dark:bg-neutral-950 border border-neutral-300 dark:border-neutral-700 rounded-lg text-neutral-900 dark:text-neutral-100 placeholder-neutral-400 dark:placeholder-neutral-500 focus:outline-hidden focus:border-indigo-500 pr-10 font-mono select-text"
      />
      <button
        type="button"
  ...
  {#if tokenValidationError}
    <div class="p-2.5 bg-red-50 dark:bg-red-950/40 border border-red-300 dark:border-red-800/60 rounded-lg text-xs text-red-800 dark:text-red-300">
      {tokenValidationError}
    </div>
  {/if}

  {#if tokenValidationSuccess}
    <div class="p-3 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-300 dark:border-emerald-800/60 rounded-lg flex items-center gap-3">
