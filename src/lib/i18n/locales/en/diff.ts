...
export const diff: typeof viDiff = {
  ...
  viewDiff: "Diff",
  viewDiffTooltip: "View differences (Diff Mode)",
  viewFullFile: "Full File",
  viewFullFileTooltip: "View entire file source code at this commit version",
  deletedNotice: "This file was deleted in this commit",
  linesCount: "{count} lines",
  copyFullFileTooltip: "Copy entire file content",
  copiedFullFileToast: "Full file content copied to clipboard.",
