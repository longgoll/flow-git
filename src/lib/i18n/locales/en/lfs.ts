...
export const lfs: typeof viLfs = {
  ...
  trackPlaceholder: "Add LFS tracking pattern (e.g. *.psd, *.mp4, *.zip)...",
  trackBtn: "Track Pattern",
  untrackBtn: "Untrack",
  untrackTooltip: "Untrack pattern {pattern} in .gitattributes",
  pullFileBtn: "Pull LFS File",
  pullingFile: "Pulling...",
  trackSuccess: "Added LFS tracking pattern: {pattern}",
  untrackSuccess: "Untracked LFS pattern: {pattern}",
  trackError: "Failed to track LFS pattern",
  untrackError: "Failed to untrack LFS pattern",
  pullFileSuccess: "Successfully pulled LFS file: {path}",
};
