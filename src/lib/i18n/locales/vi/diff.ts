export const diff = {
  ...
  viewDiff: "Diff",
  viewDiffTooltip: "Xem so sánh khác biệt (Diff Mode)",
  viewFullFile: "Toàn bộ tệp",
  viewFullFileTooltip: "Xem toàn bộ mã nguồn của tệp tại phiên bản commit này",
  deletedNotice: "Tệp này đã bị xóa trong commit này",
  linesCount: "{count} dòng",
  copyFullFileTooltip: "Sao chép toàn bộ nội dung tệp",
  copiedFullFileToast: "Đã sao chép toàn bộ nội dung tệp.",
